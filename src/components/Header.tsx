        ...
        >
          <CarouselContent>
            <CarouselItem className="md:basis-full">
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-6 bg-white">
                <div className="md:w-1/2 space-y-6 text-right">
                  <h2 className="text-4xl md:text-5xl font-bold text-primary">حلول برمجية متكاملة</h2>
            ...
            <CarouselItem className="md:basis-full">
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-6 bg-white">
                <div className="md:w-1/2 space-y-6 text-right">
                  <h2 className="text-4xl md:text-5xl font-bold text-primary">دعم فني متخصص على مدار الساعة طوال الأسبوع</h2>
                  <p className="text-xl md:text-2xl text-gray-700">
            ...
            <CarouselItem className="md:basis-full">
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-6 bg-white">
                <div className="md:w-1/2 space-y-6 text-right">
                  <h2 className="text-4xl md:text-5xl font-bold text-primary">استضافة مخصصة وفائقة التميز</h2>
                </div>
                <div className="md:w-1/2">
                  <img 
          ...
          <CarouselPrevious className="absolute left-4 top-1/2 -translate-y-1/2 bg-white border-primary text-primary" />
          <CarouselNext className="absolute right-4 top-1/2 -translate-y-1/2 bg-white border-primary text-primary" />
        </Carousel>
      </div>
    </header>
  );
